...
const dbInstanceSize = config.get("dbInstanceSize") || "db.t3.micro";
...
const ec2InstanceSize = config.get("ec2InstanceSize") || "t3.micro";
...
const cloudflareIpv6CidrBlocks = [
    "2400:cb00::/32",
    "2606:4700::/32",
    "2803:f800::/32",
    "2405:b500::/32",
    ...
    ingress: [
        {
            ...
            toPort: 443,
            protocol: "tcp",
            cidrBlocks: cloudflareCidrBlocks,
            ipv6CidrBlocks: cloudflareIpv6CidrBlocks,
        },
        {
            description: "HTTP",
            fromPort: 80,
